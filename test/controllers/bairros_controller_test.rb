...
class BairrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bairro" do
    assert_difference('Bairro.count') do
      post bairros_url, params: { bairro: { city_id: @bairro.city_id, descricao: @bairro.descricao, latitude: @bairro.latitude, longitude: @bairro.longitude, ref: @bairro.ref } }
    end
  ...
  test "should update bairro" do
    patch bairro_url(@bairro), params: { bairro: { city_id: @bairro.city_id, descricao: @bairro.descricao, latitude: @bairro.latitude, longitude: @bairro.longitude, ref: @bairro.ref } }
